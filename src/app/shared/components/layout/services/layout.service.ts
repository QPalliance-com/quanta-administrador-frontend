...
export class LayoutService {
    _config: layoutConfig = {
        primary: 'mrp', // Color corporativo predeterminado (MRP)
        surface: null,
        darkTheme: false,
        menuMode: 'static',
        menuTheme: 'mrp', // Color corporativo predeterminado (MRP)
        topbarTheme: 'mrp', // Color corporativo predeterminado (MRP)
    ...
    /**
     * Activa el tema MRP (menu, topbar y color primario)
     */
    activateMrpTheme(): void {
        this.layoutConfig.update((config: layoutConfig) => ({
            ...config,
            menuTheme: 'mrp',
            topbarTheme: 'mrp',
            primary: 'mrp'
    ...
    /**
     * Restaura el tema por defecto (puedes personalizar los valores por defecto aquí)
     */
